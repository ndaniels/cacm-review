...
including sequence, abundance, structure, function, and interaction of DNA, RNA, and proteins.
It is the success of these methods that has led to the massive influx of biological data we address today.
...
For this Review, it is important to understand the structure of NGS sequence data, so we give a bit more description.
...
%The assembly problem in so-called `shotgun sequencing' is analogous to the problem of 
