...
% YWY: Take spell-check lines out of figure axes labels! (TeraFLOPS, KiloBase)
\begin{figure*}[htb!]
\centering
...
with both each other (interaction networks) and small chemical compound agonists.

% YWY: "Most" is an extremely strong claim. I believe you, but I could see people
% arguing (e.g. all of electronic health records could be considered "biological")
...
Chemical compounds represent another source of structural data.
Although generically much smaller than proteins, their structures are more general
as they are not constrained in composition to amino acids.
...
% YWY: 7 hours for whom? Perhaps "even on an institutional connection"?
...
\includegraphics[height=2.6in]{assets/shotgun.png}
\label{fig:shotgun}
}
...
\includegraphics[height=2.6in]{assets/snps.png}
\label{fig:snps}
}\\
