...
e.g. several approaches make use of diffusion/random walks to explore the topology of networks \cite{cao2013going,cho2015diffusion}---
...
However, given its breadth, biological network science is beyond the scope of this Review, so we will not focus on that here.
...
\textbf{TODO(NMD): remove/re-integrate section}.
